...
from sign.dataset.university import U1652DatasetEval, U1652DatasetTrain, get_transforms
from sign.utils import setup_system, Logger
from sign.trainer import train
from sign.evaluate.university import evaluate
from sign.loss.loss import InfoNCE
from sign.loss.blocks_infoNCE import blocks_InfoNCE
from sign.loss.blocks_mse import blocks_mse
...
if config.dataset == 'U1652-D2S':
    config.query_folder_train = '/home3/mzq/data/University-Release/train/satellite/'
    config.gallery_folder_train = '/home3/mzq/data/University-Release/train/drone/'   
    config.query_folder_test = '/home3/mzq/data/University-Release/test/query_drone/' 
    config.gallery_folder_test = '/home3/mzq/data/University-Release/test/gallery_satellite/'    
elif config.dataset == 'U1652-S2D':
    config.query_folder_train = '/home3/mzq/data/University-Release/train/satellite/'
    config.gallery_folder_train = '/home3/mzq/data/University-Release/train/drone/'      
    config.query_folder_test = '/home3/mzq/data/University-Release/test/query_satellite/'
    config.gallery_folder_test = '/home3/mzq/data/University-Release/test/gallery_drone/'
...
if __name__ == '__main__':
    ...
    loss_fn1 = InfoNCE(loss_function=loss_fn,
                            device=config.device,
                            )

    loss_fn2 = blocks_InfoNCE(loss_function=loss_fn, device=config.device)

    loss_functions = {"infoNCE": loss_fn1, "blocks_infoNCE": loss_fn2}
