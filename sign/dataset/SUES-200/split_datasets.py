...
parser.add_argument('--path', type=str,
                    default=r'/home7/mzq/data/SUES-200-512x512/',
                    help='dataset path')
...
f = open("sign/dataset/SUES-200/indexs.yaml", 'r', encoding="utf-8")
...
Training_path = os.path.join(raw_datasets_path, "train")
Testing_path = os.path.join(raw_datasets_path, "test")
